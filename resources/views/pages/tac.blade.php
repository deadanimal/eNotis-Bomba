                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="form-group">
                            <label class=" h3 form-control-label text-white">Masukkan kod</label>
                            <br>
                            <label class="form-control-label text-white">Kod Pengguna telah dihantarkan ke +6012-3456789</label>
                            <div class="input-group">
                                <input type="number" aria-label="input1" class="form-control" maxlength="1">
                                <input type="number" aria-label="input2" class="form-control" maxlength="1">
                                <input type="number" aria-label="input3" class="form-control" maxlength="1">
                                <input type="number" aria-label="input4" class="form-control" maxlength="1">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-12">
                        <a href="/log-masuk" class="btn btn-success w-100 mt-3 mb-2">Seterusnya</a>
                    </div>
                </div>
