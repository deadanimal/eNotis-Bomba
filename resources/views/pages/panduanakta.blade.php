    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-xl-12">
                <div class="row">
                    <div class="col-6">
                        <a href="/panduan-penetapan-masa" class="btn btn-default w-100" type="button">Penetapan Masa</a>
                    </div>
                    <div class="col-6">
                        <a href="/panduan-akta" class="btn btn-info w-100" type="button">Senarai akta</a>
                    </div>
                </div>
            </div>
            <div class="col-xl-12">
                <!-- <embed src="../../assets/file/panduan_pengguna_akta.pdf" width="auto" height ="350px" /> -->
                <img src="../../assets/img/panduan_pengguna_akta.png" alt="" style="height: 350px;">
            </div>
        </div>
