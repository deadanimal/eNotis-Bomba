                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="form-group">
                            <label class=" h3 form-control-label text-white">Masukkan no. telefon</label>
                            <div class="input-group">
                                <input type="tel" aria-label="input1" class="form-control" maxlength="3">
                                <span class="input-group-text">-</span>
                                <input type="tel" aria-label="input2" class="form-control" maxlength="7">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-12">
                        <a href="/tac" class="btn btn-success w-100 mt-3 mb-2">Seterusnya</a>
                    </div>
                </div>
