                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="form-group">
                            <label class="form-control-label text-white">Nama</label>
                    ...
                    <div class="col-xl-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="password" placeholder="Tulis disini...">
                        </div>
                    </div>
                    <div class="col-xl-12">
                        <div class="form-group">
                            <label class="form-control-label text-white">Pengesahan Kata Laluan</label>
                            <input class="form-control" type="password" placeholder="Tulis disini...">
                        </div>
                    </div>
                    <div class="col-xl-12" >
