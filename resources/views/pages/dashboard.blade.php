...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Paparan Utama</a></li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Paparan Utama</h6>
            </nav>
    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-xl-12">
                <a href="/notis/create" class="btn btn-icon btn-3 btn-outline-secondary w-100">
                    <span class="btn-inner--icon"><i class="ni ni-bullet-list-67"></i></span>
                    <span class="btn-inner--text">Notis Baru</span>
                </a>
                <a href="/notis" class="btn btn-icon btn-3 btn-outline-secondary w-100">
                    <span class="btn-inner--icon"><i class="ni ni-book-bookmark"></i></span>
                    <span class="btn-inner--text">Status Notis</span>
                </a>
                <a href="/premis" class="btn btn-icon btn-3 btn-outline-secondary w-100">
