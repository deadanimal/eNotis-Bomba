...
<body>
    ...
    <p> suatu bahaya kebakaran iaitu {{ $notis->jenis_ppk }} yang {{ $notis->kesalahan }} di bahagian {{$notis->lokasi}} {{$notis->aras}} premis, dibawah {{$notis->seksyen}} yang boleh menyebab ancaman kepada keselamatan nyawa dan harta benda jika berlaku kebakaran.
