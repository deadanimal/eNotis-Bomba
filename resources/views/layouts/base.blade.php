...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="/notis/create">
        ...
        <div class="collapse navbar-collapse  w-auto h-auto max-height-vh-100 h-100" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/notis/create">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <!-- <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>shop </title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="nav-link-text ms-1">Notis Baru</span>
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="/notis">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fas fa-business-time me-sm-1 text-dark"></i>
                        </div>
                        <span class="nav-link-text ms-1">Status Notis</span>
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="/premis">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fas fa-id-badge me-sm-1 text-dark"></i>
                        </div>
                        <span class="nav-link-text ms-1">Senarai Premis</span>
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="/jadual-minggu">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fas fa-calendar-alt me-sm-1 text-dark"></i>
                        </div>
                        <span class="nav-link-text ms-1">Jadual Pemeriksaan</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/panduan-penetapan-masa">
                        ...
                        <span class="nav-link-text ms-1">Panduan Pengguna</span>
                    </a>
                </li>
            ...
            <div class="modal fade" id="logkeluarModal" tabindex="-1" role="dialog" aria-labelledby="exampleModallogkeluar" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                    <div class="modal-content">
                        <div class="modal-body p-0">
                            <div class="card card-plain">
                                <div class="card-header pb-0 text-left">
                                    <h3 class="font-weight-bolder text-dark">Log Keluar?</h3>
